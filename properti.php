            ...
            <div class="row">
                <div class="box">
                    <div class="col-lg-12">
                        ...
                        <table>
                            <tr>
                                <td><a href="tambah_properti.php?personal=true"> <button type="submit">Tambah properti</button>
                                </td>
                            </tr>
                        </table>
                    </div>
            ...
            <div class="row">
                <div class="box">
                    <div class="col-lg-12">
                        ...
                        <table>
                            <tr>
                                <td><a href="tambah_properti.php?real=true"> <button type="submit">Tambah properti</button>
                                </td>
                            </tr>
                        </table>
                    </div>
